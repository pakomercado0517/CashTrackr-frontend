  ...
  return (
    <>
      ...
      <main className="mx-auto mt-20 max-w-3xl space-y-5 p-5">
        <h1 className="text-4xl font-black text-purple-950 lg:text-6xl">
        ...
        <h2 className="text-4xl font-black text-purple-950">
          Ventajas de CashTrackr
        </h2>

        <ol className="grid grid-cols-1 items-start gap-5">
          <li className="p-5 text-lg shadow-lg">
      ...
      <nav className="mx-auto mt-10 flex max-w-3xl flex-col gap-5 pb-20 lg:flex-row lg:justify-between">
        <Link
          href="/auth/register"
          className="text-center text-sm uppercase text-gray-500"
        >
